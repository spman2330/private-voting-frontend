...
const Poll = ({ poll, setPage }) => {
  ...
  return (
    <div id="poll">
      <button class="btn btn-outline-dark" onClick={handleClick}>
        Back
      </button>
      <div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          {poll.status === "Active" && (
            <div>
              <button class="btn btn-outline-dark" onClick={handleRegister}>
      ...
      <div class="mb-3">
        {poll.status !== "Done" ? (
          ...
          <div>
            <div class="h5"> Value For: {poll.for}</div>
          </div>
        )}
      </div>
...
const Metric = ({ metric }) => {
  return (
    <div class="list-group-item rounded-3 py-2 d-flex">
      <div class="col-7">{metric.name}</div>
      <div class="col-3">{metric.factor}</div>
      <div class="col-2">
        <a>Detail</a>
      </div>
    </div>
